...
image: 'https://applegate-paul.mo.cloudinary.net/https://storage.googleapis.com/cloudinarymedia/images/airport-candid.jpg?tx=w_responsive:fallback-max-width_1500;fallback-max-width-mobile_800'
...
<Picture src={import('/src/assets/images/G400.jpg')} widths={[100, 200, 400, 800, 1600]} sizes="(max-width: 1600px) 100vw, 1600px" alt="descriptive text" aspectRatio="16:9" />
